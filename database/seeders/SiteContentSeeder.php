...
final class SiteContentSeeder extends Seeder
{
    ...
    private function defaults(): array
    {
        return [
            ...
            // --- Published policies (NELC compliance) ---
            ['policy.attendance.title', 'policies', 'text', 'عنوان سياسة الحضور', 'سياسة الحضور والمواظبة'],
            ['policy.attendance.body', 'policies', 'textarea', 'نص سياسة الحضور', 'يُحتسب الحضور في المنصة عبر التقدم الفعلي في محتوى الدورة: يُسجَّل إكمال كل درس (فيديو أو مقال أو ملف) تلقائياً في سجل تقدم المتعلم، وتُعد الدورة منجزة عند إكمال جميع دروسها واجتياز تقييماتها. في الجلسات المتزامنة (المباشرة) يُسجَّل حضور المتعلم عند انضمامه للجلسة عبر رابطها المعتمد. تتيح لوحة المتابعة للمتعلم والمشرفين الاطلاع على نسب التقدم أولاً بأول، ويُشترط لإصدار شهادة الإتمام استيفاء متطلبات الحضور والتقدم كاملة.'],
            ['policy.integrity.title', 'policies', 'text', 'عنوان سياسة النزاهة الأكاديمية', 'سياسة النزاهة الأكاديمية'],
            ['policy.integrity.body', 'policies', 'textarea', 'نص سياسة النزاهة الأكاديمية', 'تلتزم المنصة بمعايير النزاهة الأكاديمية: يجري التحقق من هوية المتعلم عبر حساب موثّق بالبريد الإلكتروني وتسجيل دخول آمن، وتُنسب جميع الأنشطة التعليمية والاختبارات لصاحب الحساب وحده. يُحظر الغش في الاختبارات والواجبات بكل صوره — بما في ذلك انتحال الشخصية، ونسخ الإجابات، ومشاركة أسئلة الاختبارات، والاستعانة غير المشروعة بالغير. تطبَّق ضوابط تقنية تشمل تحديد مدة الاختبار وعدد المحاولات وخلط الأسئلة. كل مخالفة تُوثَّق وتُراجَع، وتتدرج عواقبها من إلغاء نتيجة التقييم إلى حجب الشهادة وتعليق الحساب أو إنهائه وفق جسامة المخالفة.'],
        ];
    }
}
