...
- **المرحلة A (الامتثال/الهوية) — جارية.** اعتمد صاحب المشروع الانطلاق بها.
  ...
  - ✅ **A2 — الخدمة الذاتية للحساب** (كلمة المرور/تصدير/حذف PDPL): موقّع من مراجِع مستقلّ. أُغلقت ملاحظة الـ UX (تحديث سياق auth بعد PATCH).
  - ⏭️ A3 — إخفاء الهوية الإداري (Retirement) PDPL (يعيد استخدام `AnonymizeUser`).
