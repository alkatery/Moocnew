...
// جزيرة العميل: كل منطق الرئيسية التفاعلي (بحث/إحصاءات/أقسام/دورات/أخبار/مسارات/تواصل).
// يُصيَّر من الغلاف الخادمي page.tsx الذي يحقن JSON-LD ثابت.
// العقد: B2-content-seo.md §6.1
